            ...
            <div className="w-full bg-white pt-16 px-6">
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="relative">
                        {/* THODA AUR text */}
                        <h1 className="text-center text-[80px] md:text-[120px] lg:text-[180px] font-bold text-[#f2f2f2] leading-none tracking-tight uppercase">
                            THODA AUR
                        </h1>

                        {/* Content overlay */}
                        <div className="absolute w-full bg-white top-28 flex items-center pt-5 pb-5">
                            <div className="max-w-[95%] mx-auto">
                                <p className="text-gray-700 leading-6">
                                    ...
                                    <span className="text-[#1946b6] font-semibold">"THODA AUR"</span> in our product line, symbolizes our commitment to delivering more quality, more innovation, and more value. We believe in going the extra mile to ensure our clients receive unparalleled services and solutions that exceed expectations !
                                </p>
                            </div>
                        </div>

                        <div className='w-full'>
                            <img src={MultipleIcons} className='w-full' alt="" />
                        </div>
                    </div>
                </div>
            </div>
